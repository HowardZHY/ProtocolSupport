...
public class ProtocolStorage {
	...
	public static void setConnection(SocketAddress address, ConnectionImpl connection) {
		addConnection(address, connection);
	}

	public static void addConnection(SocketAddress address, ConnectionImpl connection) {
		primaryStorage.put(address, new Data(connection));
		secondayStorage.put(address, connection);
	}

	public static void addAddress(SocketAddress primary, SocketAddress additional) {
